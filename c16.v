module compress16(u,c);
	...
	a2 w1 (u[1+L],u[107+L],c[1+L],c[2+L]);
	if(1+L<106)
	begin : i1
		assign c[107+L]=1'b0;
		assign c[213+L]=1'b0;
	end
	a3 w2 (u[2+L],u[108+L],u[214+L],c[108+L],c[3+L]);
	if(2+L<106)
	begin : i2
		assign c[214+L]=1'b0;
	end
	a4 w3 (u[3+L],u[109+L],u[215+L],u[321+L],c[109+L],c[4+L],c[5+L]);
	if(3+L<106)
	begin : i3
		assign c[215+L]=1'b0;
	end
	a5 w4 (u[4+L],u[110+L],u[216+L],u[322+L],u[428+L],c[110+L],c[111+L],c[6+L]);
	if(4+L<106)
	begin : i4
		assign c[216+L]=1'b0;
	end
	a6 w5 (u[5+L],u[111+L],u[217+L],u[323+L],u[429+L],u[535+L],c[217+L],c[112+L],c[7+L]);
	a6 w6 (u[6+L],u[112+L],u[218+L],u[324+L],u[430+L],u[536+L],c[218+L],c[113+L],c[8+L]);
	a6 w7 (u[7+L],u[113+L],u[219+L],u[325+L],u[431+L],u[537+L],c[219+L],c[114+L],c[9+L]);
	a6 w8 (u[8+L],u[114+L],u[220+L],u[326+L],u[432+L],u[538+L],c[220+L],c[115+L],c[10+L]);
	a6 w9 (u[9+L],u[115+L],u[221+L],u[327+L],u[433+L],u[539+L],c[221+L],c[116+L],c[11+L]);
	a6 w10 (u[10+L],u[116+L],u[222+L],u[328+L],u[434+L],u[540+L],c[222+L],c[117+L],c[12+L]);
	...
	a5 w53 (u[159+L],u[265+L],u[371+L],u[477+L],u[583+L],c[265+L],c[160+L],c[55+L]);
	a4 w54 (u[266+L],u[372+L],u[478+L],u[584+L],c[266+L],c[161+L],c[56+L]);
	a3 w55 (u[373+L],u[479+L],u[585+L],c[267+L],c[162+L]);
	a2 w56 (u[480+L],u[586+L],c[268+L],c[57+L]);
	assign c[163+L]=u[587+L];
	if(57+L<106)
	begin : i57
		assign c[269+L]=1'b0;
	end
